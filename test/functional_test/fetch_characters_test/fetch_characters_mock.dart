...
class MockCharacterService extends Mock implements CharactersService {
  ...
  @override
  Future<FetchCharactersResponse> fetchCharacters({
    required FetchCharactersRequest request,
  }) async {
    await Future.delayed(timeToLoad);
    if (request.page == 0) throw const AppApiException('Bad request page should be greater than 0');
    return FetchCharactersResponse.fromJson(response);
  }
}
